...
\oneline{
\ket{\psi^{+}} = \ket{\phi}  + \hat{G}_0^{+}  \hat{H}_1 \ket{\phi} + \hat{G}_0^{+}  \hat{H}_1 \hat{G}_0^{+}  \hat{H}_1 \ket{\phi} + \cdots \ ,
}
...
Substituting \autoref{eqn:Gexpansion} into \autoref{eqn:lippmann-schwinger-Green}, we obtain
\oneline{
