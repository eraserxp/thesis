...
Equation \ref{eqn:eqnOfMotionNNA} shows that $\Tilde{G}(n, m; z)$ only relates directly with at most four other Green's
...
Equations \ref{eqn:VkNNN} and \ref{eqn:VkPlusNNN} can be written as
\oneline{
