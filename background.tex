...
\end{equation}
\Autoref{eqn:addition}, \autoref{exact-relation2} and \autoref{exact-relation3} describe the exact
...
\oneline{
P_{n'e'}P_{ne}^{\dagger} - P_{ne}^{\dagger}P_{n'e'}=\delta_{nn'}\delta_{ee'} \ ,  \label{eqn:bosonCommutation}
}
\oneline{
