...
%To answer this question, we assume that $C_{n = n_0}(t=0) = 1$ and apply \autoref{Cn(t)} to
 %calculate the coefficients $C_m(t)$ at $t=-\tau$. This backforward-in-time calculation yields the site
 %representation, i.e., $C_m(t)$, of the initial wave packet that will focus onto the lattice site $n_0$ after evolving for 
%time $\tau$. 
...
and run a backward-in-time evolution to calculate the coefficients $C_m(t)$ at $t=-\tau$. This  
calculation will yields the site representation, i.e., $C_m(t)$, of the initial wave packet that will focus onto the lattice 
site $n_0$ after evolving for time $\tau$. 
