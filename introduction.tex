...
dipole operator as $\mathbf{\hat{d}} = \matelement{\psi}{\boldsymbol{\mu}} {\psi}$ by integrating over the electronic and
...
where $P$ is the parity operator. It follows that molecules in a rotational eigenstate have no permanent dipole moment as $\matelement{J, M}{\mathbf{\hat{d}}} {J, M} = 0$. At ultracold temperatures, in consideration of stability against inelastic collisions, 
