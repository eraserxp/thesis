...
&=& \sum_{m^{\prime}} \ket{j, m^{\prime}} \bra{j', m^{\prime}} D(R) \ket{j, m} \delta_{j, j'} \nonumber \\
...
\multiline{
D^{l}_{m, 0}(\phi, \theta, \chi) &=& C_{l m}^{*}(\theta, \phi) = \sqrt{\frac{2 l + 1}{4 \pi } } Y_{l m}^{*}(\theta, \phi) \ , \nonumber \\
D^{l}_{0, m}(\phi, \theta, \chi) &=& C_{l -m} (\theta, \phi) = \sqrt{\frac{2 l + 1}{4 \pi } } Y_{l -m} (\theta, \phi) \  .
...
transforms like
\oneline{
T_{ijk \cdots } \rightarrow \sum_{i^{\prime}} \sum_{j^{\prime} } \sum_{k^{\prime} }\sum_{\cdots} R_{i, i^{\prime}} R_{j, j^{\prime}} R_{k, k^{\prime} }\cdots T_{i^{\prime} j^{\prime} k^{\prime} \cdots } \ . 
}
...
\multiline{
 \left[  \mathbf{A}^{(1)} \otimes \mathbf{B}^{(1)} \right]^{(2)}_{q}  &=& \sum_{q_{A}, q_B } \braket{1, q_{A} ; 1, q_{B} } {2, q} T^{(1)}_{q_{A} } (\mathbf{A})  T^{(1)}_{q_B } (\mathbf{B}) \nonumber \\
&=& \sum_{q_{A}, q_B } (-1)^q \sqrt{5} \threejm{1}{q_A }{1}{q_B }{2}{-q} T^{(1)}_{q_{A} } (\mathbf{A})  T^{(1)}_{q_B } (\mathbf{B})
...
= \sum_{q_{A}, q_B } (-1)^q \sqrt{5} \threejm{1}{q_A }{1}{q_B }{2}{-q} T^{(1)}_{q_{A} } (\mathbf{d}_A )  T^{(1)}_{q_B } (\mathbf{d}_B )
...
= \sum_{s_{A}, s_B } (-1)^s \sqrt{5}d_A d_B \threejm{1}{s_A }{1}{s_B }{2}{-s} C_{1 s_A} C_{1 s_B}
...
&&= (-1)^{s + M_A + M_B} d_A d_B \sqrt{5} \sqrt{(2 N_A + 1)(2 N_B + 1) (2 N_A^{\prime} + 1)  (2 N_B^{\prime} + 1)} \nonumber \\
&&\hspace{0.5cm} \times \threejm{N_A}{0}{1}{0}{N_A^{\prime}}{0} \threejm{N_B}{0}{1}{0}{N_B^{\prime}}{0} \nonumber \\
&&\hspace{0.5cm} \times \sum_{s_A, s_B } \threejm{N_A}{-M_A}{1}{s_A}{N_A^{\prime}}{M_A^{\prime}} \threejm{N_B}{-M_B}{1}{s_B}{N_B^{\prime}}{M_B^{\prime}} \threejm{1}{s_A}{1}{s_B}{2}{-s} \ . \nonumber \\
...
This is called the Pauli commutation relation as \autoref{eqn:fermionCommutation} looks like the commutation relation for fermions  and \autoref{eqn:bosonCommutation} looks like the commutation relation for 
