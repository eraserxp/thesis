...
transform $G(n+\delta n, m+\delta m, n, m; t)$ represents the amplitude for the two particles to move a distance
 $\delta n$ and  $\delta m$ respectively in time $t$ \cite{economou2006, Berciu2010}. To figures out what Green's 
...
$|K - K_c | \rightarrow \infty$. For the purpose of numerical computation, a cutoff distance $N$ is chosen such that
$\mathbf{V}_{K_c - N}$ and $\mathbf{V}_{K_c + N}$ are very small. Under this assumption, the infinite crystal is 
replaced by a finite cystal whose centers are site $n^{\prime}$ and $m^{\prime}$. 
