...
\oneline{
\gamma = \arccos\left[ \frac{x_j - y_i }{\sqrt{(x_i - x_j)^2 + (y_i - y_j)^2} } \right] \ ,
}
...
\oneline{
\dot{\Psi}(t) = \frac{1}{i\hbar} H(t) \Psi(t) \ .
} 
...
\oneline{
H_{1}(\theta(t), \phi(t) ) = 3\cos^2[\theta(t) ]*\bigg\{\cos[\phi(t)]*H_{\cos} + \sin[\phi(t)]*H_{\sin} \bigg\}**2 - 1
}
