...
\oneline{
P_{n'e'}P_{ne}^{\dagger} - P_{ne}^{\dagger}P_{n'e'}=0 \quad\mbox{for $n \neq n'$ or $e \neq e'$} \ ,  \label{eqn:bosonCommutation}
}
\oneline{
...
Now we consider the Heitler-London approximation where each molecule has only two energy levels: the ground 
...
\multiline{
H_1 = \sum_{i} \left\{ (\varepsilon_{e} - \varepsilon_{g}) + \sum_{j\neq i}\bigg[ \matelement{eg}{V_{ij} }{eg} - \matelement{gg}{V_{ij} }{gg} \bigg] \right\} P^{\dagger}_{ie} P_{ie} \ ,
}
\multiline{
H_2 = \sum_{i, j\neq i} \matelement{eg}{V_{ij} }{ge} P^{\dagger}_{ie} P_{je} \ ,
}
\multiline{
H_3 = \frac{1}{2} \sum_{i, j\neq i} \matelement{eg}{V_{ij} }{ge} \left( P^{\dagger}_{ie} P^{\dagger}_{je} +  P_{ie} P_{je} \right) \ ,
}
\multiline{
H_4 = \frac{1}{2} \sum_{i, j\neq i} \bigg[ \matelement{ee}{V_{ij} }{ee} + \matelement{gg}{V_{ij} }{gg} - 2 \matelement{eg}{V_{ij} }{eg}\bigg]  P^{\dagger}_{ie} P_{ie} P^{\dagger}_{je}  P_{je}  \ ,
}
\multiline{
H_5 =  \sum_{i, j\neq i} \matelement{eg}{V_{ij} }{gg} \left( P^{\dagger}_{ie} +  P_{ie} \right) \ ,
}
\multiline{
H_6 = \sum_{i, j\neq i} \bigg[ \matelement{eg}{V_{ij} }{ee} - \matelement{eg}{V_{ij} }{gg}\bigg]  \left(P^{\dagger}_{ie} + P_{ie} \right) P^{\dagger}_{je}  P_{je}  \ .
}
...
\subsection{Eigenstates of the exciton Hamiltonian}
