...
Consider a Gaussian wave packet with a narrow width $\sigma_{k}$ which centers around $k=0$ in $k$ space
\multiline{
C_k(t=0) =  A e^{-\frac{ a^2 k^2}{2\sigma ^2_{k} } } \ , \label{eqn:initialWavepacketInk}
}
...
\multiline{
C_n(t=0) &=& \sum_{k} C_k(t=0) e^{ - i k a n} \nonumber \\
&\approx& \int_{-\infty}^{\infty} dk \; e^{-\frac{a^2 k^2}{2\sigma ^2_{k} }  - i k a n}  \nonumber \\
&=& e^{-\frac{n^2 }{2\sigma ^2_{k} } }\int_{-\infty}^{\infty} dk \; A\; e^{-\frac{1}{2\sigma ^2_{k} } (k a + i  n \sigma^2 )^2 } \nonumber \\
&=& \frac{\sigma \sqrt{2\pi} }{a} \;A\; e^{-\frac{n^2 \sigma ^2_{k} }{2 } } \nonumber \\
&\propto&  e^{-\frac{n^2 }{2(1/\sigma_k) ^2} }
} 
